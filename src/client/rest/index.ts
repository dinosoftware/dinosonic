...
import getSonicSimilarTracks from './getSonicSimilarTracks.ts';
import findSonicPath from './findSonicPath.ts';
...
restRoutes.route('/', getSonicSimilarTracks);
restRoutes.route('/', findSonicPath);
